...
<title>Confirma&ccedil;&atilde;o de Email</title>
</head>
<body>
	<div id="tudo">
		<div id="content">
			...
			<img style = "margin-top: 30px;"src = "imagens/ok.png">
				<p style = "color: #555555;	font-size: 20px;">Um email de confirma&ccedil;&atilde;o foi enviado. Siga as instru&ccedil;&otilde;es do email para concluir o seu cadastro.</p>
			</div>
